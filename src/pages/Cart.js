          ...
          <div className="flex-1">
            ...
            <div className="mb-10">
              ...
              {selectedPayment === 'card' && (
                <div className="bg-gray-100 dark:bg-white/5 p-6 rounded-2xl border border-slate-800">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="md:col-span-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-900 border-slate-700 rounded-xl px-4 py-3 focus:ring-primary focus:border-primary text-gray-900 dark:text-white" 
                    ...
                    <div className="md:col-span-2 relative">
                      ...
                      <div className="relative">
                        <input 
                          ...
                          onChange={handleInputChange}
                          className="w-full bg-slate-900 border-slate-700 rounded-xl px-4 py-3 pr-12 focus:ring-primary focus:border-primary text-gray-900 dark:text-white" 
          ...
          <div className="lg:w-[400px]">
            <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-800 sticky top-28">
              ...
              <div className="space-y-3 pt-6 border-t border-slate-700 mb-6">
                ...
                <div className="flex justify-between text-lg font-bold text-gray-900 dark:text-white pt-2 border-t border-dashed border-slate-700">
                  <span>Total</span>
              ...
              <button 
                ...
                className="w-full bg-primary hover:bg-primary/90 text-gray-900 dark:text-white font-bold py-4 rounded-xl shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-2 group"
              >
